...
public sealed class ActivityService(IActivityProjectionRepository repository)
{
    ...
    private static readonly HashSet<string> ResourceTypes=["organization-membership","branch","branch-configuration","catalog-menu-item","media-asset","notification","payment-intent","kitchen-ticket"];
