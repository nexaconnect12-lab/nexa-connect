...
{
    private static readonly HashSet<string> Actions=["customer-membership.changed","branch.created","branch.updated","branch.configuration.updated","catalog.menu-item.changed","media.asset.created","media.asset.quarantined","media.asset.deleted","media.asset.upload-expired","notification.queued","payment.intent.created","payment.authorization.started","payment.authorization.succeeded","payment.authorization.failed","payment.authorization.uncertain","payment.authorization.reconciled","payment.capture.started","payment.capture.succeeded","payment.capture.failed","payment.capture.uncertain","payment.capture.reconciled","order.payment-review.resolved","order.manual-tender.settled","kitchen.ticket.queued","kitchen.ticket.started","kitchen.ticket.ready","kitchen.ticket.completed","kitchen.ticket.cancelled","customer.profile.created"];
    private static readonly HashSet<string> ResourceTypes=["organization-membership","branch","branch-configuration","catalog-menu-item","media-asset","notification","payment-intent","order","kitchen-ticket","customer-profile"];
