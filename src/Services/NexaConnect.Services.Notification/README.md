...
Notification uses the in-memory adapter by default. Set `Persistence:Provider=PostgreSQL` and `ConnectionStrings:Notification` to persist queued notifications.
