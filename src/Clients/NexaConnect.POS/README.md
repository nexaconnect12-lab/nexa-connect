...
See [cashier acceptance and remaining limits](../../../docs/Deployment/POS-Cashier-Acceptance.md) for the test commands, live acceptance procedure, supported window size, and the distinction between protected client replay and incomplete server workflow recovery. Local interactive OIDC/cash checkout passed before the SQLite upgrade on 2026-09-10. Fresh SQLite-backed live evidence, full reconciliation reporting, named cashier context, and physical-terminal acceptance remain open.
