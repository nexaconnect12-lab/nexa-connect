...
export type PortalSection = "profile"|"products"|"users"|"configuration"|"branches"|"dashboards"|"reports"|"media"|"activity";
export const sections:readonly PortalSection[]=["profile","products","users","configuration","branches","dashboards","reports","media","activity"];
