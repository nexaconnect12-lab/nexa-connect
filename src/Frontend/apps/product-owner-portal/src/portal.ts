export const capabilitiesByRole: Readonly<Record<string, readonly string[]>> = {
  "platform-owner": ["summary.read", "organizations.manage", "memberships.manage", "products.manage", "subscriptions.manage", "users.manage", "roles.read", "audit.read", "support.request", "support.approve", "admin-links.open"],
  "platform-admin": ["summary.read", "organizations.manage", "memberships.manage", "products.manage", "subscriptions.manage", "users.manage", "roles.read", "audit.read", "support.request", "support.approve", "admin-links.open"],
  "platform-support": ["summary.read", "roles.read", "support.request"],
  "platform-auditor": ["summary.read", "roles.read", "audit.read"]
};
