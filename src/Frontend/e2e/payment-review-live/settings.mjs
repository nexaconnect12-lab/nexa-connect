...
export function readSettings(env){
  ...
  let base,issuer,faultControl;
  try{base=new URL(read("BASE_URL"));issuer=new URL(read("OIDC_ISSUER"));faultControl=new URL(read("FAULT_CONTROL_URL"));}catch{throw new Error("Invalid live acceptance endpoint URL.");}
