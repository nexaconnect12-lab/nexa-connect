...
Launch through [the recovery runner](../../../docs/Deployment/Cash-Close-Recovery.md#disposable-recovery-acceptance), which manages generated infrastructure and child lifecycle. The local Windows matrix passed 2/2 with no skips on 2026-09-24; see [evidence and exclusions](../../../docs/Architecture/Evidence/Cash-Close-Recovery-Acceptance.md).
