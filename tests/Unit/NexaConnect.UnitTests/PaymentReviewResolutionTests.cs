...
public sealed class PaymentReviewResolutionTests
{
    ...
    private sealed class Inventory:IInventoryReservationPort{public int Calls{get;private set;}public Task<InventoryReservationResult> ReserveAsync(Guid organizationId,Guid orderId,Guid branchId,IReadOnlyCollection<OrderLine> lines,CancellationToken cancellationToken)=>throw new NotSupportedException();public Task ReleaseAsync(Guid organizationId,Guid orderId,Guid branchId,CancellationToken cancellationToken){Calls++;return Task.CompletedTask;}}
