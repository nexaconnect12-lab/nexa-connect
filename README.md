...
Phase 8 provides the independently buildable Customer Portal in `src/Frontend/apps/customer-portal`. Organization profile, product switching, membership and branch management, typed product configuration, Reporting dashboards/sales/activity-preview reads, and Media list and presigned object lifecycle are available as a development preview. Media compares object size and client-declared checksum metadata; malware scanning, variants, and reconciliation remain staged.
